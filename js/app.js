...
const MUSIC_SPECIALTIES = [
  { key: 'accordion', hasEE: true },
  { key: 'harp', hasEE: true },
  { key: 'electric_bass', hasEE: false },
  { key: 'singing', hasEE: false },
  { key: 'valencian_singing', hasEE: false },
  { key: 'clarinet', hasEE: true },
  { key: 'harpsichord', hasEE: true },
  { key: 'doublebass', hasEE: true },
  { key: 'dulzaina', hasEE: true },
  { key: 'bassoon', hasEE: true },
  { key: 'flute', hasEE: true },
  { key: 'recorder', hasEE: true },
  { key: 'guitar', hasEE: true },
  { key: 'electric_guitar', hasEE: false },
  { key: 'early_plucked_strings', hasEE: true },
  { key: 'plectrum_instruments', hasEE: false },
  { key: 'oboe', hasEE: true },
  { key: 'organ', hasEE: false },
